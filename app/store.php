 ...
 if(isset($_POST['submitbtn']))
  {
    ...
    $totalquantity=htmlspecialchars(trim($_POST['total_quantity']));
    $sid=htmlspecialchars(trim($_POST['staff_id']));
       
    

    $sql = "INSERT INTO stores (`product_categories_id`,`total_quantity`,`staff_id`)
           VALUES ('$pcid','$totalquantity','$sid')";
        ...
        <div class="container">
            <div class="form-row">
                    <div class="form-group col-md-12">
                        <h5 stle="text-align:center">STORE</h5>
                    </div>
                    ...
                    <div class="form-group col-md-6">
                        <label for="inputEmail4">TOTAL QUANTITY</label>
                        <input type="text" name="total_quantity" class="form-control" id="inputEmail4" placeholder="price"required>
                    </div>
